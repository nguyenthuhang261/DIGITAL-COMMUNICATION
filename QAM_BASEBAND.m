...
title('Muc bien do cua tin hieu 4-QAM truoc khi qua kenh truyen');
...
title('Muc bien do cua tin hieu 4-QAM sau khi qua kenh truyen');
xlabel('Thoi gian t(s)');
ylabel('Bien do');
grid on;
...
title('Gian do chom sao tin hieu 4-QAM truoc khi qua kenh truyen');
grid on;

subplot(1, 2, 2);
plot(real(rt_sample), imag(rt_sample), 'bo', 'MarkerSize', 8);
title('Gian do chom sao tin hieu 4-QAM sau khi qua kenh truyen');
grid on;

% c
eyediagram(real(st), 2*sps, Tsym);
set(gcf, 'Name', 'Gian do mat tin hieu 4-QAM truoc khi qua kenh truyen');

eyediagram(real(rt), 2*sps, Tsym);
set(gcf, 'Name', 'Gian do mat tin hieu 4-QAM sau khi qua kenh truyen');
